import type { CurvyPublicKeys, Signature } from "@/core/types";
...
// Client-proved submission and relay wire contract. Proofs are generated by the
// caller and authenticated by the on-chain verifier.
...
/** Lifecycle of a relayed submission. */
